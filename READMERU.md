...
Для отображения данных с датчика рекомендуем использовать наш удобный [сервис](http://82.202.142.35:8080)

Проект на котором основана библиотека а также старые [исходники сервиса](https://github.com/ArduRadioKot/AquariusEcoCase)
